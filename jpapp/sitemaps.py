...
def custom_sitemap_index(request):
    ...
    sitemaps = [
        {'loc': 'https://www.janpunjab.com/sitemap/news', 'lastmod': now},
        {'loc': 'https://www.janpunjab.com/sitemap/videos', 'lastmod': now},
        {'loc': 'https://www.janpunjab.com/sitemap/articles', 'lastmod': now},
        {'loc': 'https://www.janpunjab.com/sitemap/images', 'lastmod': now},
        {'loc': 'https://www.janpunjab.com/sitemap/archive', 'lastmod': now},
        {'loc': 'https://www.janpunjab.com/sitemap/tags', 'lastmod': now},
        {'loc': 'https://www.janpunjab.com/sitemap/static', 'lastmod': now},
        {'loc': 'https://www.janpunjab.com/sitemap/categories', 'lastmod': now},
    ]
...
def sitemap_news(request):
    ...
    for item in news_items:
        try:
            ...
            'loc': f"https://www.janpunjab.com{url}",
                'lastmod': item.updated_at.strftime('%Y-%m-%dT%H:%M:%SZ'),
                'publication_name': 'janpunjab',
                'language': 'en',
...
def sitemap_images(request):
    ...
    sitemap_list = [{'loc': f"https://www.janpunjab.com/sitemap/images/{key}", 'lastmod': value} for key, value in sitemap_entries.items()]
...
def sitemap_images_by_month(request, year, month):
    ...
    sitemap_entries = [
        {
            'loc': f"https://www.janpunjab.com{post.get_absolute_url()}",
            'image': f"https://www.janpunjab.com{post.post_image.url}",
...
def sitemap_videos(request):
    ...
    sitemap_list = [{'loc': f"https://www.janpunjab.com/sitemap/videos/{key}", 'lastmod': value} for key, value in sitemap_entries.items()]
    ...
    sitemap_entries = [
        {
            ...
            'thumbnail': f"https://www.janpunjab.com{post.video_thumbnail.url}" if post.video_thumbnail else "",
            'lastmod': post.updated_at.strftime('%Y-%m-%dT%H:%M:%SZ'),
...
def sitemap_article(request):
    ...
    sitemap_list = [{'loc': f"https://www.janpunjab.com/sitemap/articles/{key}", 'lastmod': value} for key, value in sitemap_entries.items()]
...
def sitemap_archive(request):
    ...
    sitemap_list = [{'loc': f"https://www.janpunjab.com/sitemap/archive/{key}", 'lastmod': value} for key, value in sitemap_entries.items()]
...
def sitemap_tags(request):
    ...
    for tag in tags:
        ...
        urls.append({
            'loc': f"https://www.janpunjab.com{tag.get_absolute_url()}",
...
def sitemap_static(request):
    ...
    for name in static_names:
        try:
            loc = f"https://www.janpunjab.com{reverse(name)}"
        except Exception:
            continue
        urls.append({
            'loc': loc,
...
def sitemap_categories(request):
    ...
    for cat in cats:
        ...
        urls.append({
            'loc': f"https://www.janpunjab.com/all-news/{cat.cat_slug}",
        ...
        for sub in subs:
            ...
            urls.append({
                'loc': f"https://www.janpunjab.com/{cat.cat_slug}/{sub.subcat_slug}",
