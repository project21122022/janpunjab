...
# -------------end-ad-manage-meny--------------   
    ...
    parent_category = subcatid.sub_cat if subcatid else None
...
def SubscribeView(request):
    if request.method == "POST":
        ...
        try:
            ...
            message = f"""
            Subject: Welcome to Jan Punjab - Your Source for Insightful News!
            Dear {fname},
            Thank you for subscribing to Jan Punjab! Stay updated with the latest news.
                Regards,
                Jan Punjab
            """
            send_mail(
                "Welcome to Jan Punjab",
                message,
...
def send_otp(request):
    if request.method == "POST":
        ...
        send_mail(
            "Your Secure OTP for Jan Punjab",
...
def Adsinquiry(request):
    ...
    if request.method == 'POST':
        ...
        from_email = 'no-reply@janpunjab.comm'
...
def robots_txt(request):
    content = """User-agent: *
        ...
        Sitemap: https://www.janpunjab.com/sitemap
        """
