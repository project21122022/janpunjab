...
class Post_cat(admin.ModelAdmin):
    ...
    list_editable=('cat_name','cat_slug','cat_status','order',)
    list_display_links = None
    search_fields=('cat_name','cat_slug',)
    list_filter=('cat_status','order',)
    ordering=('order', 'cat_name',)
...
class Post_subcat(admin.ModelAdmin):
    ...
    list_editable=('subcat_name','subcat_slug','subcat_status','order','subcat_tag',)
    list_display_links = None
    list_filter=('subcat_status','sub_cat','order')
    search_fields=('subcat_name','subcat_slug','subcat_tag','sub_cat__cat_name',)
    ordering=('sub_cat','order', 'subcat_name',)
