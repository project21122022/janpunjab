...
class category(models.Model):
    ...
    cat_slug=AutoSlugField(populate_from='cat_name',unique=True,null=True,default=None,editable=True)
    STATUS_CHOICES = (
        ('active', 'Active'),
        ('inactive', 'Inactive'),
    )
...
class sub_category(models.Model):
    ...
    subcat_slug=AutoSlugField(populate_from='subcat_name',unique=True,null=True,default=None,editable=True)
...
class VideoNews(models.Model):
    ...
    slug=AutoSlugField(populate_from='video_title',unique=True,null=True,default=None,editable=True)
